...
class Article:
    def __init__(self, identifier=None, headline=None, articleBody=None, url=None, source_domain=None,
        ...
        self.calculateRating = calculate_rating
        self.calculateRatingDetail = calculate_rating_detail
    ...
    def article_from_dict(self, data):
        ...
        if 'fakeness' in list(data.keys()):
            ...
            self.fakeness = cfg.default_field
        ...
        art = Article(identifier=self.identifier, headline=self.headline, articleBody=self.articleBody, url=self.url,
                      ...
                      nationality=self.nationality, calculate_rating=self.calculateRating,
                      calculate_rating_detail=self.calculateRatingDetail, fakeness=self.fakeness)
    ...
    def build_output(self):
        ...
        try:
            ...
            if self.fakeness != cfg.default_field and self.fakeness is not None:
    ...
    def get_required_properties():
        properties = ["identifier", "headline", "articleBody", 'url', "language",
                      ...
                      "nationality", "calculateRating", "calculateRatingDetail"]
        return properties