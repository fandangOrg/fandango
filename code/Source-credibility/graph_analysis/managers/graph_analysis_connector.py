...
class GraphAnalysis:
    ...
    def extract_authors_from_document(self, document: Article) -> dict:
        ...
        try:
            ...
            for aut_name in document.authors:
                ...
                # author_data.append({"identifier": uuid_aut, "source_data": source_data})
    ...
    def extract_publisher_from_document(self, document) -> dict:
        ...
        try:
            ...
            for pub_name in document.publisher:
                ...
                if not response:
                    ...
                    source_data = pub_obj.build_output()
    ...
    def retrieve_data_from_publisher(self, publisher_name: str):
        response: dict = {}
        try:
            response: dict = self.source_credibility_analyzer.retrieve_source_information(
