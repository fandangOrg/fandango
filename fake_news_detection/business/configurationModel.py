...
from ds4biz_predictor_core.model.transformers.transformers import ColumnTransformer, FunTransformer
from ds4biz_predictor_core.model.transformers.transformers import Transformer
from sklearn.feature_extraction.text import TfidfVectorizer


def create_trasformer_predictor(name_classifier:str=None,
