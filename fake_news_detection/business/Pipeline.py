...
class ScrapyService:
    ...
    def preprocessing(self, raw_news:News_raw) -> News_DataModel:
        ...
        # payload["fakeness" ]= ""
        u = URLRequest(self.url_prepocessing + "/preprocessing/online/preprocess_article")
        j = json.dumps(payload)
...
class AnalyticsService(metaclass=Singleton):
    ...
    def _get_authors_org_ids(self, news_preprocessed:News_DataModel) -> Author_org_DataModel:
        u = URLRequest(self.url_authors + "/graph_analysis/online/analyse_article")
