...
def get_counter_by_author() -> int:
    j = request.get_json()
    author = j.get('author')
    print(author,"annotated ",dao_annotation.get_counter_by_author(author),"articles")
    return(dao_annotation.get_counter_by_author(author))
...
app.add_service("get_counter_by_author",get_counter_by_author, method = 'POST')
CORS(app)
