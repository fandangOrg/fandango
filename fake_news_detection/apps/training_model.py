...
def training(model_name:str, sample_size:float=1.0):
    training_set = DAOTrainingPD().get_train_dataset(sample_size=sample_size)
...
if __name__ == '__main__':
    training(model_name="modello_en2", sample_size=0.01)
    predict("modello_en2")
