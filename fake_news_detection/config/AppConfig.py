...
url_service_image = os.environ.get("URL_SERVICE_CERTH_IMAGE") or config.get("configurationservice", "image_service_url") 
url_service_video = os.environ.get("URL_SERVICE_CERTH_VIDEO") or config.get("configurationservice", "video_service_url") 
url_service_media = os.environ.get("URL_SERVICE_CERTH_MEDIA") or config.get("configurationservice", "media_service_url") 
