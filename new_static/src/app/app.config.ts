...
export const InfoVideo = 'InPainting detection: Has any frame of the video been altered in any way? Red shows areas with high probability of manipulation, Blue shows areas with low probability of manipulation';
