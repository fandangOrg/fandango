    ...
    d.AxisBase = d.Class({
        construct: function (a) {
            ...
            this.periods = [{period: "fff", count: 1}, {period: "fff", count: 5}, {
                ...
                period: "YYYY",
                count: 5
            }, {period: "YYYY", count: 10}, {period: "YYYY", count: 50}, {period: "YYYY", count: 100}];
...
(function () {
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            if (isNaN(a)) return NaN;
            var c = this.rotate, e = this.reversed, d = this.axisWidth, f = this.stepWidth, h = this.min,
                k = this.minReal;
    ...
    d.AmGraph = d.Class({
        construct: function (a) {
            ...
            var a = this.chart, b = this.id, c = this.index, e = this.data, g = this.chart.container,
                f = this.valueAxis, h = this.type, k = this.columnWidthReal, l = this.showBulletsAt;
            ...
            var ma = this.categoryAxis, na = this.baseCoord, Pa = this.negativeBase, Z = this.columnIndex,
                da = this.lineThickness, X = this.lineAlpha, xa = this.lineColorR, ea = this.dashLength, fa = this.set,
                Ba, ga = this.getGradRotation(), V = this.chart.columnSpacing, Y = ma.cellWidth, Da = (Y * k - r) / r;
            V > Da && (V = Da);
                        ...
                        case "ohlc":
                            if (!(isNaN(ua) || isNaN(zb) || isNaN(Ab) || isNaN(W))) {
                                ...
                                if (t) {
                                    ...
                                    if (E == pa && O == pa && qa == pa && sa == pa) continue;
                                    var Ib = F -
                                        k / 2, Ib = d.fitToBounds(Ib, 0, q), Tb = d.fitToBounds(F, 0, q),
                                    ...
                                    var ka = E, ra = d.fitToBounds(ra, 0, Fa), ta = d.fitToBounds(ta, 0, Fa),
                                        ...
                                        Lb = E + k / 2, Lb = d.fitToBounds(Lb, 0, n);
            ...
            if (1 < a.length) {
                ...
                var m = this.lineAlpha, n = this.lineThickness, g = this.dashLength, q = this.fillAlphas,
                    p = this.lineColorR, t = this.fillColorsR, r = this.negativeLineColor, w = this.negativeFillColors,
...
(function () {
    ...
    d.ChartCursor = d.Class({
        construct: function (a) {
            ...
            var b = this.prevIndex, c = this.chart;
            if (c) {
                var e = c.chartData;
            ...
            if (this.drawingNow) {
                ...
                var a = this.drawStartX, b = this.drawStartY, c = this.mouseX, e = this.mouseY, g = this.chart;
    ...
    d.SimpleChartScrollbar = d.Class({
        construct: function (a) {
            ...
            if (this.skipEvent) this.skipEvent = !1; else {
                var a = this.chart;
                a.hideBalloon();
                var b = this.getDBox(), c = b.x, d = b.y, g = b.width, b = b.height;
                this.getPercents();
            ...
            var a = this.getDBox(), b = a.x, c = a.y, d = this.iconLeft, g = this.iconRight, f, h,
            ...
            if (!a.resizingRight && !a.resizingLeft) {
                ...
                a.updateOnReleaseOnly ? (a.skipEvent = !1, g.setAttr(b, c), a.dispatchScrollbarEvent(), a.clipDragger()) : (a.animating = !0, c = Math.round(c), m ? g.animate({y: c}, e, ">") : g.animate({x: c}, e, ">"), a.forceClip = !0, clearTimeout(a.forceTO), a.forceTO = setTimeout(function () {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var r = this.horizontalPadding, w = this.verticalPadding, z = this.pointerWidth,
                        x = this.pointerOrientation, u = this.cornerRadius, A = c.fontFamily, y = this.fontSize;
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var b = a.chart, c = b.container, e, g, f, h, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory,
                ...
                w = a.finalXValue, z = a.initialValue, x = a.finalValue, u = p.recalculateToPercents,
                A = b.dataDateFormat;
    ...
    d.Bezier = d.Class({
        construct: function (a, b, c, e, g, f, h, k, l, m, n) {
            ...
            if (2 < a.length) for (var g = 0; g < a.length - 1; g++) {
                ...
                0 === g ? (f.push({x: k.x, y: k.y}), f.push({x: k.x, y: k.y}), f.push({x: l.x, y: l.y}), f.push({
                    x: m.x,
                    y: m.y
                })) : g >= a.length - 2 ? (f.push({x: h.x, y: h.y}), f.push({x: k.x, y: k.y}), f.push({
                    x: l.x,
                    y: l.y
                }), f.push({x: l.x, y: l.y})) : (f.push({x: h.x, y: h.y}), f.push({x: k.x, y: k.y}), f.push({
                    x: l.x,
                    y: l.y
                }), f.push({x: m.x, y: m.y}));
                h = [];
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                var b = this, c = b.chart, e = b.useGraphSettings, g = a.markerType;
                g && (e = !1);
...
(function () {
    ...
    d.stringToDate = function (a, b) {
        var c = {}, e = [{pattern: "YYYY", period: "year"}, {pattern: "YY", period: "year"}, {
            ...
            pattern: "K",
            period: "hours"
        }, {pattern: "LL", period: "hours"}, {pattern: "L", period: "hours"}, {
            pattern: "NN",
            period: "minutes"
        }, {pattern: "N", period: "minutes"}, {pattern: "SS", period: "seconds"}, {
            pattern: "S",
            period: "seconds"
        }, {pattern: "QQQ", period: "milliseconds"}, {pattern: "QQ", period: "milliseconds"}, {
            pattern: "Q",
            period: "milliseconds"
        }], g = !0, f = b.indexOf("AA");
